...
export const ITEMS = [
  ...
  { id: 'mktg', name: 'Marketing Content Package', benefit: 'Done-for-you content, ready from day one.', group: 'customers', desc: 'Professional video and done-for-you project case-study content from day one.', info: 'Done-for-you marketing content, ready on day one: professional video and project case-study material produced from real jobs. Finished assets you can put in front of prospects immediately, made for you rather than built from scratch.', mo: 415, cashNum: 10000, cash: '$10,000' },
...
// ============================================================================
// CapEx (outright purchase) pricing — mirrors the Sherpa Package one-pager.
// Organized by category/section. The core drone is always included; everything
// else is an optional add-on. Item types:
//   core: true        -> the base aircraft, always in the total
//   suite: true       -> dual pricing ($/mo OR up-front); priceUp used in total
//   infoOnly: true    -> shown for reference with a link, no price, not in total
// ============================================================================
  ...
  },
  {
    ...
    items: [
      { id: 'mktg', name: 'Marketing Content Package', price: 10000,
        desc: 'Done-for-you project case-study content from day one.', info: 'Done-for-you marketing content: professional video and project case-study material from your own jobs, ready to put in front of prospects. Finished assets you can use immediately, produced for you.' },
    ],
  },
  {
...
export function capexTotal(selectedIds) {
  ...
  CAPEX_ITEMS.forEach((it) => {
    const included = it.core || selectedIds.includes(it.id);
    if (!included) return;
